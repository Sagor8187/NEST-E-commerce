...
function Itemscard({ onAddToCart }) {
      ...
      {item.map((data, index) => (
        <div key={index}
          ...
          <div className="flex justify-between items-center mt-3">
            ...
            <button onClick={() => onAddToCart(data)} className="flex items-center gap-1 bg-green-100 text-green-600 font-semibold px-3 py-1 rounded-lg hover:bg-green-200 transition">
